pragma Ada_2022;
--  ==========================================================================
--  Test_Integration_Create_Greeting
--  ==========================================================================
...
--
--  Purpose:
--    Test suite for Integration Create Greeting. Validates functionality using AUnit framework.
--
--  Usage:
--    Run via test suite:
...
package Test_Integration_Create_Greeting is
