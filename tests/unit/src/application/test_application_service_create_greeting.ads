pragma Ada_2022;
--  ==========================================================================
--  Test_Application_Service_Create_Greeting
--  ==========================================================================
...
--
--  Purpose:
--    Test suite for Application Service Create Greeting. Validates functionality using AUnit framework.
--
--  Usage:
--    Run via test suite:
...
package Test_Application_Service_Create_Greeting is
